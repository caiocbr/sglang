...
def require_mlp_tp_gather():
    ...
    if get_parallel().enable_dp_attention:
        ...
        if (
            ...
            # Fixed-geometry MoE A2A backends need a rank-invariant,
            # DP-synchronized per-rank token count. No literal MLP TP-gather
            # happens here; reuse this flag's DP-sync bookkeeping.
            return True
